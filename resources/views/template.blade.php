        ...
        <nav class="navbar navbar-default">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" rel="home" href="#" title="logo da Cissa"> <img
                                style="margin-top: -15px; width: 50px; height: 50px;"
                                src="{{ asset('/img/cissa.JPG') }}" class="img-circle pull-left" alt="foto do usuario"/>
                        CodeCommerce</a>
                </div>
