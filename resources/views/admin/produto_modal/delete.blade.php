<div class="modal fade" id="confirmDelete" tabindex="-1" role="dialog" aria-labelledby="confirmDelete">
                ...
                <div>
                     <h4 class="text-info"><i class="fa fa-pencil fa-3x"></i>Produtos</h4>
                </div>
           </div>
                                    <div class="modal-body">
                                        <p>Tem certeza que deseja deletar {{ $produto->name }}?</p>
                                    </div>
                                    <div class="modal-footer">
                                        <a class="btn btn-danger" href="{{ route('admin.produto.deletarProduto',['id'=>$produto->id]) }}"><i class="fa fa-trash fa-lg"></i> Deletar</a>
